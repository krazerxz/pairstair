...
Then "I should see collaborations in the database" do
  ...
  expected_result = [{"card" => "565341d7b9ea6441ae681cf6", "last_activity_date" => Time.parse("Mon, 07 Dec 2015 11:25:47")},
                     {"card" => "565d6da875cd637f3c1fcf82", "last_activity_date" => Time.parse("Sun, 13 Dec 2015 20:18:59")}]
  expected_members = [["53cc170795d646b10dd1159e"], %w(55acd5018b4a2a1a0afe7d74 5652f11b1be7f1189b548048)]
